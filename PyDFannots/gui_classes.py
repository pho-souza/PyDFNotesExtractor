...
from PyDFannots.utils import path_normalizer,  is_dir
...
class gui_pdf_load(gui_interface):
    ...
    def assets_import(self):
        self.icon_delete = tk.PhotoImage(file = os.path.abspath("PyDFannots/gui_assets/delete.png"))
        self.icon_trash = tk.PhotoImage(file = os.path.abspath("PyDFannots/gui_assets/trash.png"))
    ...
    def basic_ui(self):
        ...
        # Status bar
        self.status_bar = ttk.Label(self.row_3, textvariable=self.vars["status_text"])
